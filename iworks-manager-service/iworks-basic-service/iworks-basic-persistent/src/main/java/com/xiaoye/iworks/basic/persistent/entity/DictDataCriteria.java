 ...
 */
public class DictDataCriteria extends Condition {
    @Override
    public Class<? extends Entity> geEntityClass() {
        return DictDataDO.class;
    }
    public DictDataCriteria() {
    ...
    public class GeneratedCriteria extends Criteria {
        ...
        public GeneratedCriteria andFsignIsNull() {
            addCriterion("`Fsign` is null");
            return this;
        }
        public GeneratedCriteria andFsignIsNotNull() {
            addCriterion("`Fsign` is not null");
            return this;
        }
        public GeneratedCriteria andFsignEqualTo(String value) {
            if(StringUtils.isBlank(value)) return this;
            addCriterion("`Fsign` =", value, "fsign");
            return this;
        }
        public GeneratedCriteria andFsignNotEqualTo(String value) {
            if(StringUtils.isBlank(value)) return this;
            addCriterion("`Fsign` <>", value, "fsign");
            return this;
        }
        public GeneratedCriteria andFsignLike(String value) {
            if(StringUtils.isBlank(value)) return this;
            addCriterion("`Fsign` like", String.format("%s%s%s", "%", value, "%"), "fsign");
            return this;
        }
        public GeneratedCriteria andFsignNotLike(String value) {
            if(StringUtils.isBlank(value)) return this;
            addCriterion("`Fsign` not like", String.format("%s%s%s", "%", value, "%"), "fsign");
            return this;
        }
        public GeneratedCriteria andFsignIn(List<String> values) {
            if(CollectionUtils.isEmpty(values)) return this;
            addCriterion("`Fsign` in", values, "fsign");
            return this;
        }
        public GeneratedCriteria andFsignNotIn(List<String> values) {
            if(CollectionUtils.isEmpty(values)) return this;
            addCriterion("`Fsign` not in", values, "fsign");
            return this;
        }
        public GeneratedCriteria andFsignBetween(String value1, String value2) {
            if(StringUtils.hasBlankString(value1, value2)) return this;
            addCriterion("`Fsign` between", value1, value2, "fsign");
            return this;
        }
        public GeneratedCriteria andFsignNotBetween(String value1, String value2) {
            if(StringUtils.hasBlankString(value1, value2)) return this;
