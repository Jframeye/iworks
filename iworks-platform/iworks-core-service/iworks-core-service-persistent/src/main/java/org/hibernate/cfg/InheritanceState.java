...
public class InheritanceState {
	...
	public ElementsToProcess getElementsToProcess() {
		if ( elementsToProcess == null ) {
			...
			// 颠倒顺序 :字段从类到父类
			classesToProcessForMappedSuperclass.sort(new Comparator<XClass>() {
				@Override
				public int compare(XClass o1, XClass o2) {
					return classesToProcessForMappedSuperclass.indexOf(o2) - classesToProcessForMappedSuperclass.indexOf(o1);
				}
			});
	...
	private void addMappedSuperClassInMetadata(PersistentClass persistentClass) {
		...
		PersistentClass superEntity =
				superEntityState != null ?
						...
						null;
		// TODO 因顺序颠倒，此处修改 classes from 1 to n are @MappedSuperclass and should be linked
		// TODO final int lastMappedSuperclass = classesToProcessForMappedSuperclass.size() - 1;
		final int lastMappedSuperclass = classesToProcessForMappedSuperclass.size();
		for ( int index = 1; index < lastMappedSuperclass; index++ ) {
